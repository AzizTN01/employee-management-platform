					...
					<td > <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"> <?php echo  $row['N'] ?> </button>
					   ...
					   <td class=""><b><?php echo $row['nom'] ?></b></td>
						...
						<td><b><?php
						 ...
						 <a href="./index.php?page=attestation&id=<?php echo $row['ID'] ?>"    class="btn btn-secondary btn-flat "  data-id="<?php echo $row['id'] ?> ">
...
<script>
	$(document).ready(function(){
		$('#list tbody').on('click', '.print', function () {
	_conf("Voulez-vous vraiment supprimer ce stagierel?","print",[$(this).attr('data-id')])
	})
		$('#list').dataTable()
